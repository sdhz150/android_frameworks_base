...
public class TaskViewHeader extends FrameLayout
    ...
    private void updateLockTaskDrawable() {
        if (TaskStack.sLockedTasks.contains(mTask)) {
    ...
    public void onClick(View v) {
        if (v == mIconView) {
            ...
            if (!TaskStack.sLockedTasks.contains(tv.getTask())) {
                tv.dismissTask();
            ...
            if (TaskStack.sLockedTasks.contains(mTask)) {
               TaskStack.sLockedTasks.remove(mTask);
            } else {
               TaskStack.sLockedTasks.add(mTask);
            }
            updateLockTaskDrawable();
        }
    }
